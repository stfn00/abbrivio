...
<!-- wp:cover {"url":"<?php echo esc_url(ABBRIVIO_BUILD_IMG_URI . '/patterns/cover.jpg') ?>","id":3854,"minHeight":640,"align":"full","className":"abbrivio-cover"} -->
<div class="wp-block-cover alignfull has-background-dim abbrivio-cover mt-5 mb-5" style="background-image: url(<?php echo esc_url(ABBRIVIO_BUILD_IMG_URI . '/patterns/cover.jpg') ?>); min-height: 640px;">
    <div class="wp-block-cover__inner-container">
        ...
        <div class="wp-block-buttons aligncenter">
            ...
            <div class="wp-block-button is-style-outline">
				<a class="wp-block-button__link has-cyan-bluish-gray-color has-text-color">Blogs</a>
			</div>
            <!-- /wp:button -->
        </div>
        <!-- /wp:buttons -->
