...
// Menu
$menu_class = \Abbrivio_Theme\Inc\Menus::get_instance();
$header_menu_id = $menu_class->get_menu_id('abbrivio-header-menu');
...
<nav class="navbar navbar-expand-lg navbar-light fixed-top bg-light">
	<div class="container-fluid">
		...
		<a class="navbar-brand" href="<?php echo home_url(); ?>">
			<img src="<?php echo $theme_options['abbrivio-site-logo']; ?>" />
		</a>
		<!-- Button -->
