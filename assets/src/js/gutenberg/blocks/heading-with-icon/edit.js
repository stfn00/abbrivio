...
const Edit = ( props ) => {
	...
	return (
		<div className="abbrivio-icon-heading">
			<span className="abbrivio-icon-heading__heading">
				<HeadingIcon />
			</span>
			...
			<RichText
				...
				placeholder={ __( 'Heading…', 'abbrivio' ) } // Display this text before any content has been added by the user
			/>
			<InspectorControls>
				<PanelBody title={ __( 'Block Settings', 'abbrivio' ) }>
					<RadioControl
						label={ __( 'Select the icon', 'abbrivio' ) }
						help={ __( 'Controls icon selection', 'abbrivio' ) }
						selected={ option }
						options={ [
							{ label: 'Dos', value: 'dos' },
